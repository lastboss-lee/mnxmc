...
| 관리 콘솔 버전 | **MNXMC v2.3.2** (deb 패키지 트랙) | `/mnxmc/.claude/CLAUDE.md`, `/data/mnxmc-2.3.2.deb` |
...
### 3.1 `/mnxmc` — 관리 콘솔 (MNXMC v2.3.2, Python/Textual TUI)
...
| 항목 | 역할 | 근거 |
|---|---|---|
| `/data/mnxmc-{2.1.3,2.1.4,2.2.0,2.3.0,2.3.2}.deb` | 콘솔 설치 패키지(버전 이력) | `ls /data` |
