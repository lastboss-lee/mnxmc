...
header-includes:
  ...
  - \usepackage{xeCJK}
  - \xeCJKsetup{CJKspace=true,CJKecglue={\hskip 0.1em plus 0.05em}}
  - \XeTeXlinebreaklocale "ko"
  - \XeTeXlinebreakskip = 0pt plus 1pt minus 0.1pt
  - \XeTeXlinebreakpenalty = 0
  - \usepackage{fvextra}
  - \usepackage{mdframed}
  - \AtBeginDocument{\DefineVerbatimEnvironment{Highlighting}{Verbatim}{breaklines=true,breakanywhere=true,breaksymbolleft={\textcolor{mnxaccent}{\tiny\ensuremath{\hookrightarrow}}},commandchars=\\\{\},fontsize=\small,xleftmargin=4pt}}
  - \AtBeginDocument{\renewenvironment{Shaded}{\begin{mdframed}[backgroundcolor=codebg,linecolor=coderule,linewidth=0.4pt,innerleftmargin=6pt,innerrightmargin=6pt,innertopmargin=4pt,innerbottommargin=4pt,skipabove=4pt,skipbelow=4pt]\small}{\end{mdframed}}}
  ...
  - \AtBeginEnvironment{longtable}{\small\rowcolors{2}{white}{tblhead!30}}
  - \usepackage{titlesec}
  - \titleformat{\section}{\Large\bfseries\color{mnxdark}}{\thesection.}{0.6em}{}[\vspace{-6pt}{\color{mnxaccent}\rule{\linewidth}{0.8pt}}]
...
| generate_pdf_report.sh | 1.0.0 (2026-05-20) |
| pandoc | 2.9.2.1 |
