...
header-includes:
  ...
  - \usepackage{fvextra}
  - \usepackage{mdframed}
  - \DefineVerbatimEnvironment{Highlighting}{Verbatim}{breaklines=true,breakanywhere=true,breaksymbolleft={\textcolor{mnxaccent}{\tiny\ensuremath{\hookrightarrow}}},commandchars=\\\{\},fontsize=\small,xleftmargin=4pt}
  - \renewenvironment{Shaded}{\begin{mdframed}[backgroundcolor=codebg,linecolor=coderule,linewidth=0.4pt,innerleftmargin=6pt,innerrightmargin=6pt,innertopmargin=4pt,innerbottommargin=4pt,skipabove=4pt,skipbelow=4pt]\small}{\end{mdframed}}
